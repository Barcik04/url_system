...
//    private final EmailSender emailSender; // your abstraction
...
//
//        // Safety: only process what dispatcher marked
//        if (e.getStatus() != OutboxEvent.Status.PROCESSING) return;
//
//        try {
//            EmailPayload p = objectMapper.readValue(e.getPayload(), EmailPayload.class);
//
